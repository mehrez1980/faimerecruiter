...
WebUI.setText(findTestObject('Page_opencats - Login/input_Username_username'), 'admin')

WebUI.acceptAlert()

WebUI.setText(findTestObject('Page_opencats - Login/input_Password_password'), 'admin')
